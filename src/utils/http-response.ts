...
const exceptions = {
    ...
    [HttpStatus.NON_AUTHORITATIVE_INFORMATION]  : ['NON_AUTHORITATIVE_INFORMATION',   203 ],
    ...
    [HttpStatus.PROXY_AUTHENTICATION_REQUIRED]  : ['PROXY_AUTHENTICATION_REQUIRED',   407 ],
    ...
    [HttpStatus.REQUESTED_RANGE_NOT_SATISFIABLE]: ['REQUESTED_RANGE_NOT_SATISFIABLE', 416 ],
